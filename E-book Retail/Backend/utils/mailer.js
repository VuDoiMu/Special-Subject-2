...
const adminEmail = '1901040026@s.hanu.edu.vn'
const adminPassword = '1901040026'
...
const sendMail = (to, subject, htmlContent) => {
  ...
  const options = {
    ...
    text: htmlContent // Phần nội dung mail mình sẽ dùng html thay vì thuần văn bản thông thường.
  }
