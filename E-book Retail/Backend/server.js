...
app.get("/", async (req, res) => {
  ...
  if(token) {
    ...
    const newtoken = jwt.sign({ userId: updateUser._id, role: updateUser.role, username: updateUser.username, favorbooks: updateUser.favorbooks, inventory: updateUser.inventory }, "thisisourwebsite!");
